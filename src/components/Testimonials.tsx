...
const Testimonials = () => {
  return (
    <section className='min-h-screen bg-black scroll-mt-18' id='depoimentos'>
      <div className='w-full max-w-8xl mx-auto px-4 py-8'>
        <div className='flex flex-col justify-center items-center gap-8 w-full max-w-xl mx-auto'>

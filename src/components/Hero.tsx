...
const Hero = () => {
  ...
  return (
    <section className='h-[110dvh] bg-black overflow-hidden'>
      <motion.header 
        ...
        <div className='max-w-8xl flex items-center justify-between mx-auto py-4'>
          ...
          <nav>
            <ul className='flex gap-3 justify-between items-center'>
              ...
              <li className='text-gray cursor-pointer px-6 hover:text-pink hover:underline' onClick={() => scrollToSection('contato')}>
                Contato
              </li>
            </ul>
          </nav>
